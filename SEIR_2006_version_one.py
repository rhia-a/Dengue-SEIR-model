...
mu=0.04 #mosquito death rate (avg lifespan of ~25 days) fixed
...
def objective(params):
    ...
    scaled_beta, epsilon, phi, r, E0, I0, R0 = params #defining my parameters
    beta = scaled_beta*1e-6 #scaling beta as scipy works better with bigger numbers
    model_cases = model(beta,epsilon,phi,mu,r,sigma, gamma, E0, I0, R0)
...
scaled_beta, best_epsilon, best_phi, best_r, best_E0, best_I0, best_R0 = result.x
...
model_cases = model(best_beta,best_epsilon,best_phi,mu,best_r,sigma,gamma,best_E0,best_I0,best_R0)

ret = odeint(seir_m_model,y_0,t,args=(N, best_r, k0, best_epsilon, best_phi,mu, best_beta, sigma, gamma, chi)) 
M, S, E, I, R = ret.T
